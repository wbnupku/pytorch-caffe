...
python verify_time.py --protofile SFD/deploy.prototxt --weightfile SFD/SFD.caffemodel --imgfile data/cat.jpg --meanB 104 --meanG 117 --meanR 123 --scale 255 --height 480 --width 960 --cuda
